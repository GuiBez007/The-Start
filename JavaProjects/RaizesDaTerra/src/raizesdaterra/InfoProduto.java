...
public class InfoProduto extends javax.swing.JFrame {
    private static InfoProduto produto;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1313, 672, 30, 30));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1529, 672, 30, 30));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1096, 758, 535, 70));

        jButton5.setContentAreaFilled(false);
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1096, 843, 535, 70));
        ...
        jTextField2.setText("1 unidades");
        jTextField2.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1372, 673, 130, 30));

        backGround2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/raizesdaterra/imagens/backgrounds/ProductDescription.png"))); // NOI18N
        getContentPane().add(backGround2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 170, 1740, 840));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String number = "";
        int i = 0;
        while (jTextField2.getText().charAt(i) != ' ') {
            number = number + jTextField2.getText().charAt(i);
            i++;
        }
        int quantidade = Integer.parseInt(number);
        if (quantidade > 1)
            jTextField2.setText(Integer.toString(quantidade - 1) + " unidades");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        FormaEntrega.getInstance().setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton4ActionPerformed

    
    public static InfoProduto getInstance() {
        if (produto == null)
            produto = new InfoProduto();
        return produto;
    }
