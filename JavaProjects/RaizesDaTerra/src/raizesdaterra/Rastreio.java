 ...
 * @author PEG
 */
public class Rastreio extends javax.swing.JFrame {
    private static Rastreio rastreio;
    ...
    private void initComponents() {
        ...
        backGround2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/raizesdaterra/imagens/backgrounds/RastreioScreen_v2.png"))); // NOI18N
        getContentPane().add(backGround2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 200, 1670, 780));
    ...
    public static Rastreio getInstance() {
        if (rastreio == null)
