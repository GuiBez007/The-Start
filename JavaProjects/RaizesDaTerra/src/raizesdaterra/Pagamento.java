...
public class Pagamento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1850, 10, 60, 30));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(662, 858, 580, 59));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 611, 666, 55));
        ...
        getContentPane().add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(598, 436, -1, -1));

        jRadioButton2.setContentAreaFilled(false);
        getContentPane().add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(599, 734, -1, -1));

        backGround2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/raizesdaterra/imagens/backgrounds/PagamentoScreen.png"))); // NOI18N
        getContentPane().add(backGround2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 130, 1750, 910));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        NovoCartao.getInstance().setVisible(true);
        this.setEnabled(false);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(jRadioButton1.isSelected() == false && jRadioButton2.isSelected() == false)
            JOptionPane.showMessageDialog(null, "Selecione um meio de pagamento!", "Erro!", 2);
        else if(jRadioButton1.isSelected() == true) {
            ADEUS adeus = new ADEUS();
            adeus.setVisible(true);
            this.dispose();
        }
