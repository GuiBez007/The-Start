...
public class MinhasVendas extends javax.swing.JFrame {
    private static MinhasVendas vendas;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(518, 295, 306, 38));

        jTextField9.setBackground(new java.awt.Color(223, 158, 62));
        jTextField9.setFont(new java.awt.Font("SansSerif", 0, 24)); // NOI18N
        getContentPane().add(jTextField9, new org.netbeans.lib.awtextra.AbsoluteConstraints(1359, 300, 188, 38));

        jTextField10.setBackground(new java.awt.Color(223, 158, 62));
        jTextField10.setFont(new java.awt.Font("SansSerif", 0, 24)); // NOI18N
        getContentPane().add(jTextField10, new org.netbeans.lib.awtextra.AbsoluteConstraints(1039, 300, 187, 38));

        jTextField11.setEditable(false);
        jTextField11.setBackground(new java.awt.Color(249, 198, 126));
        jTextField11.setFont(new java.awt.Font("SansSerif", 0, 29)); // NOI18N
        jTextField11.setForeground(new java.awt.Color(51, 153, 0));
        jTextField11.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        jTextField11.setText("Pedido Enviado");
        ...
        getContentPane().add(jTextField11, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 560, 270, 38));

        jTextField12.setEditable(false);
        jTextField12.setBackground(new java.awt.Color(249, 198, 126));
        jTextField12.setFont(new java.awt.Font("SansSerif", 0, 26)); // NOI18N
        jTextField12.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextField12.setText("1");
        jTextField12.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        getContentPane().add(jTextField12, new org.netbeans.lib.awtextra.AbsoluteConstraints(1237, 560, 100, 38));

        jTextField13.setEditable(false);
        jTextField13.setBackground(new java.awt.Color(249, 198, 126));
        jTextField13.setFont(new java.awt.Font("SansSerif", 0, 29)); // NOI18N
        jTextField13.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        jTextField13.setText("158,00");
        jTextField13.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        getContentPane().add(jTextField13, new org.netbeans.lib.awtextra.AbsoluteConstraints(1580, 560, 170, 38));

        jTextField14.setEditable(false);
        jTextField14.setBackground(new java.awt.Color(249, 198, 126));
        jTextField14.setFont(new java.awt.Font("SansSerif", 0, 29)); // NOI18N
        jTextField14.setText("15/08/2024 17:50");
        jTextField14.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        getContentPane().add(jTextField14, new org.netbeans.lib.awtextra.AbsoluteConstraints(543, 560, 250, 38));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(185, 513, 314, 128));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1183, 399, 362, 35));

        backGround2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/raizesdaterra/imagens/backgrounds/SaleScreen.png"))); // NOI18N
        getContentPane().add(backGround2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 200, 1700, 610));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        InfoPedido.getInstance().setVisible(true);
    ...
    public static MinhasVendas getInstance() {
        if (vendas == null)
            vendas = new MinhasVendas();
        return vendas;
    }
    ...
    public void setjTextField11(String situacao) {
        jTextField11.setText(situacao);
    }
    ...
    public void setjButton3(String msg) {
        this.jButton3.setText(msg);
    }
